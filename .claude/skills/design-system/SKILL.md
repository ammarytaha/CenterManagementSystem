---
name: design-system
description: Visual design language for all UI output in this project — a polished enterprise dashboard aesthetic with a purple brand identity (#7E22CF), pill-shaped UI elements, clean data-dense layouts, and automatic light/dark mode. Use when building or styling any UI work: components, pages, layouts, dashboards, or admin panels.
---
...
## Style
A polished enterprise dashboard interface with a purple brand identity (#7E22CF), pill-shaped UI elements (9999px radius), clean data-dense layouts, and a modern professional aesthetic suited for application and admin panels
...
- [radius.md](radius.md) — border-radius scale (9999px pill default, 24px for cards)
