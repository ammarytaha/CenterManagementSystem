...
- **Wrapper:** full width, 1px border (border-default color), 9999px radius — clips first/last item corners
...
### Separated Cards
Each item is independent — has its own 1px border, 24px radius (card style), and shadow-xs. 8px bottom margin between items. No shared outer border.
