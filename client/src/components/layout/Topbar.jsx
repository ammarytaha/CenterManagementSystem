    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-border-default bg-neutral-primary-soft px-4 sm:px-6">
      <div className="flex items-center gap-3">
        <button
          ...
          className="rounded-pill p-2 text-heading transition-colors hover:bg-neutral-secondary-medium focus:outline-none focus:ring-4 focus:ring-neutral-tertiary lg:hidden"
        >
